"""
Script para ejecutar entrenamiento de modelos LSTM para múltiples estaciones y horizontes.
...
def run_batch_training(
    ...
    steps_list : list[int]
        Lista de pasos de predicción (ej: [24, 48, 72])
    use_exog : bool
    ...
    for station in stations:
        for steps in steps_list:
            ...
            print(f"Estación: {station}, Steps: {steps}")
            if horizon > 0:
                print(f"Horizonte de shift: {horizon}")
            print(f"{'#' * 80}\n")
...
if __name__ == "__main__":
    ...
    STEPS = [n for n in range(1, 2)] # lista del 7 al 36
    ...
    # Si quieres personalizar el grid, descomenta y modifica:
    # PARAM_GRID = {
    ...
    #     "batch_size": [128, 256],
    # }
    PARAM_GRID = None  # Usa valores por defecto del modelo
