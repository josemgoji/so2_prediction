...
class DataBuilderService:
    ...
    def load_without_freq(
        ...
        """
        Carga datos principales y opcionalmente los combina con datos exógenos.
        Similar a load() pero SIN aplicar asfreq("h") al final.
        Esto permite que el data_pipeline.py controle cuándo aplicar la frecuencia.
        ...
        if use_exogenous:
            ...
            # NO aplicar asfreq("h") aquí - se hará en el data_pipeline.py
            return merged_df
        else:
            # Solo retornar el DataFrame original sin datos exógenos
            # Ya tiene datetime como índice
