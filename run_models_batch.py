"""
Script para ejecutar entrenamiento de modelos para múltiples estaciones y steps.

Este script permite ejecutar el entrenamiento de modelos en batch,
...
def run_batch_training(
    ...
    """
    Ejecuta el entrenamiento de modelos para múltiples estaciones y steps.
    ...
    print(f"\n{'=' * 80}")
    print(f"INICIANDO ENTRENAMIENTO EN BATCH")
    print(f"{'=' * 80}")
    ...
    batch_summary_dir = Path(
        f"data/analytics/model_results/batch_summaries_{timestamp_str}"
    )
    ...
    print(f"\n{'=' * 80}")
    print(f"RESUMEN FINAL DEL BATCH")
    print(f"{'=' * 80}")
